...
function(record) {
    ...
    function fieldChanged(scriptContext) {
        ...
        if (sublistName === 'item' && fieldName === 'item')
        {
            ...
            if (itemId) 
            {
            var length = itemRecord.getValue('custitem_jj_length');
            var breadth = itemRecord.getValue('custitem_jj_breadth');
            var width = itemRecord.getValue('custitem_jj_width');
            var Total = length*breadth*width;
