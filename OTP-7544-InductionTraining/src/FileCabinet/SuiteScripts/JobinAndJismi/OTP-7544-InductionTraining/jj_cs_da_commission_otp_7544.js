...
function(record, search) {
    ...
    function fieldChanged(scriptContext) {
        ...
        let salesRepId = currentRecord.getValue('custpage_salesrep_commission');
        

        var mySearch = search.create({
            title: "Sales Rep Commission8",
            type: search.Type.SALES_ORDER,
            filters: [['mainline','is','T'],'AND',['salesrep','anyOf',salesRepId]],
            columns: ['total']
        });
    ...
    currentRecord.setValue({
        fieldId : 'custpage_commissionamount',
