        ...
        const beforeLoad = (scriptContext) => {
            ...
            try{
                let mySearch = search.create ({
                    ...
                    filters : ['orderstatus','anyof','Pending Fulfillment'],
                    columns: [
                        search.createColumn({ name: 'tranid', label: 'Document Number' }),
                        search.createColumn({ name: 'trandate', label: 'Date' }),
                        search.createColumn({ name: 'entity', label: 'Customer Name' }),
                        search.createColumn({ name: 'Subsidiary', join: 'customer', label: 'Subdidiary' }),
                ...
                searchResult.forEach(result => {
                    log.debug("Sales Order Details", {
                        ...
                        'Customer Name': result.getText({name : 'subsidiary'}),
